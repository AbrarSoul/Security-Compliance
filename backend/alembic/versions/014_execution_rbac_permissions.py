"""RBAC permissions for pre-execution validation and execution history
...
_NEW_PERMISSIONS = (
    ("execution:read", "View execution validation history"),
    ("execution:read_all", "View all users execution validation history"),
)

_ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    "admin": ("execution:read", "execution:read_all"),
